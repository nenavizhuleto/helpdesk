...
CREATE TABLE IF NOT EXISTS devices (
    ip TEXT NOT NULL,
    user_id TEXT,
    type TEXT NOT NULL, -- PC, Terminal, Router
    PRIMARY KEY(ip)
);
...
INSERT INTO subnets VALUES ("127.0.0.1/32", "0000-1111-0000-1111");
...
INSERT INTO subnets VALUES ("172.16.222.0/24", "gtUUID");
